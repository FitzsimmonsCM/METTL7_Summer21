...
coldata <- read.csv("/Users/fitzsimmonscm/Documents/Projects_and_Data/Collaborations/Gottesman/RNASeq_Bergel/Gottesman_Rhomedepsin.csv",
                    row.names=1)
print(coldata)
nrow(coldata)
countdata1 <- read.delim(
  "/Users/fitzsimmonscm/Documents/Projects_and_Data/Collaborations/Gottesman/RNASeq_Bergel/RawCountFile_rsemgenes.txt", row.names = 1)
