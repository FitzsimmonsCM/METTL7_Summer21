...
ggplot(data=res2MCF7, aes(x=log2FoldChange, y=-log10(padj))) + geom_point(aes(color=padj < 0.05)) + ggtitle("MCF7_M300 vs MCF7 Control") +xlab("log2 Fold Change") + ylab("-log10 padj")
