...
theme_set(theme_bw())
setwd("/Users/ryangensler/Documents/GitHub/METTL7/Summer_2021/Ryan/RyanGensler_rhomedepsin")
...
coldata <- read.csv("Gottesman_Rhomedepsin.csv",
                    row.names=1)
print(coldata)
nrow(coldata)
countdata1 <- read.delim(
  "RawCountFile_rsemgenes.txt", row.names = 1)
...
write.csv(res_export, file="/Users/ryangensler/Documents/GitHub/METTL7/Summer_2021/Ryan/RyanGensler_rhomedepsin/2021.06.12_Rhomedepsin_RNASeq_D9res_D9treatvscontrol1.csv")
```
